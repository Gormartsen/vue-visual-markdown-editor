    ...
    processToolbar: function(toolbar) {
      ...
      var buttonDefenitions = {
        ...
        'color': {
          ...
          tag: 'font',
          items: [{
            title: '<div class="color-picker-container"></div>',
            set: true,
            placeholder: 'Color',
          },
          {
            title: '<div style="text-align: center; padding: 10px 5px; border-top: 1px solid #ddd;">Reset</div>',
            set: false,
          }
          ],
          init: function(self) {
            var el = self.$el.querySelector('.color-picker-container');
          ...
          handlerText: function(self, button, callback) {
            ...
            var wrapWithFont = function(){
              ...
              self.texteditor.value = self.texteditor.value.substring(0, start)
                + self.textStart
                + content
                + self.textStop
                + self.texteditor.value.substring(stop + self.textStop.length);
              ...
              for(var n = 0; n < lastNodes.length; n ++) {
                ...
                if(childElem == false) {
                  if(['#text', 'i', 'em'].indexOf(child.nodeName.toLowerCase()) != -1) {
                    ...
                    child.innerHTML = '<font color=' + color + '>' + child.innerHTML + '</font>';
                  }
                } else {
        ...
        'size': {
          ...
          tag: 'font',
          items: [{
            title: '<font size="1">Size 1</font>',
            set: true,
            size: 1,
            placeholder: 'Size',
          },
          {
            title: '<font size="2">Size 2</font>',
            set: true,
            size: 2,
            placeholder: 'Size',
          },
          {
            title: '<font size="3">Size 3</font>',
            set: true,
            size: 3,
            placeholder: 'Size',
          },
          {
            title: '<font size="4">Size 4</font>',
            set: true,
            size: 4,
            placeholder: 'Size',
          },
          {
            title: '<font size="5">Size 5</font>',
            set: true,
            size: 5,
            placeholder: 'Size',
          },
          {
            title: '<font size="6">Size 6</font>',
            set: true,
            size: 6,
            placeholder: 'Size',
          },
          {
            title: '<font size="7">Size 7</font>',
            set: true,
            size: 7,
            placeholder: 'Size',
          },
              ...
              for(var n = 0; n < lastNodes.length; n ++) {
                ...
                if(childElem == false) {
                  if(['#text', 'i', 'em'].indexOf(child.nodeName.toLowerCase()) != -1) {
                    ...
                    child.innerHTML = '<font size=' + button.size + '>' + child.innerHTML + '</font>';
                  }
                } else {
                  childElem.size = button.size;
                }
              }
              var frag = self._extractFrags(node);
              var parent = node.parentNode
